...
router.post("/reviews/form", validation.validateReviews, helper.ensureAuthenticated, reviewController.createReview);
...
router.post("/reviews/:id/update", validation.validateReviews, reviewController.update);
